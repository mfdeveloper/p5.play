...
(function(root, factory) {
  var p5 = root.p5 || window.p5;
  if (p5) {
    factory(p5);
  } else {

    try {
      var customP5 = require.resolve('@cmu-eberly-center/p5');
      
      if (customP5) {
        if (typeof define === 'function' && define.amd)
          define('p5.play', ['@cmu-eberly-center/p5'], function(p5) { (factory(p5)); });
        else if (typeof exports === 'object')
          factory(require('@cmu-eberly-center/p5'));
      }
    } catch (err) {}
  }
}(this, function(p5) {
